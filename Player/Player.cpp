...
void Player::Initialize(const std::vector<Model*>& models, const Vector3& pos) {
	...
	spriteHP_[0].reset(
	    Sprite::Create(textureHandle_,{100.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[1].reset(
	    Sprite::Create(textureHandle_, {164.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[2].reset(
	    Sprite::Create(textureHandle_, {228.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[3].reset(
	    Sprite::Create(textureHandle_, {292.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[4].reset(
	    Sprite::Create(textureHandle_, {356.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[5].reset(
	    Sprite::Create(textureHandle_, {420.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
	spriteHP_[6].reset(
	    Sprite::Create(textureHandle_, {484.0f, 656.0f}, {1.0f, 1.0f, 1.0f, 1.0f}, {0.5f, 0.5f}));
...
void Player::Draw(const ViewProjection& view) {
	if (damageCount % 5 != 0||damageCount==0) {
...
void Player::Atack() {
	...
	newBulllet->Initialize(
	    ...
	    {worldTransformBase_.translation_.x, worldTransformBase_.translation_.y + bulletoffset,
